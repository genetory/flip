        ...
        <div className="mx-auto w-full max-w-5xl px-5 pt-6 md:pt-10">
          ...
          <div className="mt-8 grid gap-8 lg:grid-cols-[minmax(0,1fr)_360px]">
            <div className="flex flex-col gap-8">
              ...
              <Link href="/career-launch/week/3" className="group mt-1 flex items-center justify-between gap-4 rounded-2xl bg-[#191F28] p-5 transition hover:bg-[#0B1227]">
                <span className="text-[15px] font-bold text-white">{t("3주차로 돌아가기", "Back to Week 3", "返回第3周", "Quay lại Tuần 3", "Week 3に戻る", "Kembali ke Minggu 3")}</span>
