...
const authPageMessages = {
  ko: {
    ...
    signup: {
      ...
      companyNameLabel: "기업명",
      companyNamePlaceholder: "예: 주식회사 플리퍼스",
      companyNameRequired: "기업명을 입력해주세요.",
      emailRegisteredAsGeneral: "이미 일반회원으로 가입된 이메일입니다. 같은 이메일로 파트너 가입은 불가합니다.",
  ...
  en: {
    ...
    signup: {
      ...
      companyNamePlaceholder: "e.g., Flipers Inc.",
      companyNameRequired: "Please enter your company name.",
      emailRegisteredAsGeneral: "This email is already registered as a general account. Partner signup with the same email isn't allowed.",
  ...
  "zh-CN": {
    ...
    signup: {
      ...
      companyNamePlaceholder: "例如:Flipers 株式会社",
      companyNameRequired: "请输入公司名称。",
      emailRegisteredAsGeneral: "该邮箱已注册为普通会员账号,不能用同一邮箱注册合作伙伴账号。",
  ...
  vi: {
    ...
    signup: {
      ...
      companyNamePlaceholder: "Ví dụ: Flipers Inc.",
      companyNameRequired: "Vui lòng nhập tên công ty.",
      emailRegisteredAsGeneral: "Email này đã đăng ký dưới dạng tài khoản thường. Không thể đăng ký đối tác với cùng email.",
  ...
  ja: {
    ...
    signup: {
      ...
      companyNamePlaceholder: "例:株式会社 Flipers",
      companyNameRequired: "会社名を入力してください。",
      emailRegisteredAsGeneral: "このメールは既に一般会員として登録されています。同じメールでパートナー登録はできません。",
  ...
  id: {
    ...
    signup: {
      ...
      passwordConfirmPlaceholder: "Masukkan kembali kata sandi",
      passwordMismatch: "Kata sandi tidak cocok.",
      showPassword: "Tampilkan kata sandi",
      hidePassword: "Sembunyikan kata sandi",
      companyNameLabel: "Nama perusahaan",
      companyNamePlaceholder: "Misal: Flipers Inc.",
      companyNameRequired: "Silakan masukkan nama perusahaan.",
      emailRegisteredAsGeneral: "Email ini sudah terdaftar sebagai akun umum. Pendaftaran mitra dengan email yang sama tidak diperbolehkan.",
