...
export function PdfBrandFooter() {
  ...
  return (
    <footer className="mt-auto flex items-center justify-between gap-3 border-t border-[#E5E8EB] pt-4">
      ...
      <p className="text-[10px] tracking-[-0.01em] text-[#B0B8C1]">{t("첫 이력서부터 첫 지원까지", "From first resume to first application", "从第一份简历到第一次投递", "Từ hồ sơ đầu tiên đến lần ứng tuyển đầu tiên", "初めての履歴書から初めての応募まで", "Dari resume pertama hingga lamaran pertama")}</p>
    </footer>
  );
}
