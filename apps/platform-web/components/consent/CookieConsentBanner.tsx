...
const copyByLocale: Record<string, Copy> = {
  ...
  "zh-CN": {
    heading: "我们使用 Cookie",
    body: "Aply 使用 Cookie 以提供更好的服务。除必要 Cookie 外，分析和广告 Cookie 仅在您同意后启用。",
    manage: "设置",
    acceptAll: "全部允许",
    rejectAll: "仅必要",
    save: "保存选择",
    essentialLabel: "必要",
    essentialDesc: "登录、安全及核心功能所必需。",
    analyticsLabel: "分析",
    analyticsDesc: "通过 Google Analytics 等收集匿名使用统计。",
    advertisingLabel: "广告",
    advertisingDesc: "通过 Google AdSense 投放广告并衡量效果。",
    required: "始终启用",
    privacyLink: "了解更多"
  },
  vi: {
    heading: "Chúng tôi sử dụng cookie",
    body: "Aply sử dụng cookie để mang lại trải nghiệm tốt hơn. Cookie phân tích và quảng cáo chỉ bật khi bạn đồng ý.",
    manage: "Cài đặt",
    acceptAll: "Chấp nhận tất cả",
    rejectAll: "Chỉ thiết yếu",
    save: "Lưu lựa chọn",
    essentialLabel: "Thiết yếu",
    essentialDesc: "Cần cho đăng nhập, bảo mật và các tính năng chính.",
    analyticsLabel: "Phân tích",
    analyticsDesc: "Thống kê sử dụng ẩn danh qua công cụ như Google Analytics.",
    advertisingLabel: "Quảng cáo",
    advertisingDesc: "Phân phối quảng cáo Google AdSense và đo lường hiệu quả.",
    required: "Luôn bật",
    privacyLink: "Tìm hiểu thêm"
  },
  ja: {
    heading: "Cookie を使用しています",
    body: "Aply はより良い体験を提供するために Cookie を使用します。分析・広告 Cookie は同意した場合のみ有効になります。",
    manage: "設定",
    acceptAll: "すべて許可",
    rejectAll: "必須のみ",
    save: "選択を保存",
    essentialLabel: "必須",
    essentialDesc: "ログイン、セキュリティ、主要機能に必要です。",
    analyticsLabel: "分析",
    analyticsDesc: "Google Analytics などによる匿名の利用統計。",
    advertisingLabel: "広告",
    advertisingDesc: "Google AdSense による広告配信と効果測定。",
    required: "常時オン",
    privacyLink: "詳細を見る"
  },
  id: {
    heading: "Kami menggunakan cookie",
    body: "Aply menggunakan cookie untuk pengalaman yang lebih baik. Cookie analitik dan iklan hanya aktif dengan persetujuan Anda.",
    manage: "Pengaturan",
    acceptAll: "Terima semua",
    rejectAll: "Hanya penting",
    save: "Simpan pilihan",
    essentialLabel: "Penting",
    essentialDesc: "Diperlukan untuk login, keamanan, dan fitur utama.",
    analyticsLabel: "Analitik",
    analyticsDesc: "Statistik penggunaan anonim via alat seperti Google Analytics.",
    advertisingLabel: "Iklan",
    advertisingDesc: "Penayangan iklan Google AdSense dan pengukuran kinerja.",
    required: "Selalu aktif",
