...
export const Hero = () => {
  ...
  return (
    <section className="relative overflow-hidden bg-white md:h-[calc(100svh-4rem)]">
      ...
      <div className="container grid max-w-[1200px] items-center gap-8 py-11 md:h-full md:grid-cols-[1.05fr_1fr] md:gap-10 md:py-8">
        <div className="space-y-4 md:space-y-9">
          <h1 className={`${paperlogy.className} text-3xl font-black uppercase leading-[1.08] tracking-[-0.03em] text-[#0B1227] md:text-5xl md:leading-[1.15]`}>
            <span className="block">{copy.titleTop}</span>
            <span className="mt-1.5 inline-block -rotate-[1.2deg] rounded-2xl bg-[#b7ff5a] px-5 py-2.5 text-[#0B1227] shadow-[0_16px_34px_-18px_rgba(30,64,175,0.35)] md:mt-3 md:px-7 md:py-3">
              {copy.titleAccent}
            </span>
          </h1>
          <p className="max-w-[560px] whitespace-pre-line text-base leading-relaxed text-slate-600 md:text-lg">{copy.description}</p>
          <div className="flex flex-wrap items-center gap-3 pt-0 md:pt-1">
            <Button
              variant="dark"
              size="lg"
...
const HeroVisual = () => {
  ...
  <div className="relative h-[430px] md:h-[500px]">
    <div className="md:hidden">
      <div className="absolute inset-x-0 top-1 px-1 animate-float-y [animation-duration:3.7s]">
        <div className="relative rotate-[-5deg] rounded-2xl border-2 border-[#93C5FD] bg-white p-4 shadow-[0_20px_40px_-24px_rgba(37,99,235,0.65)]">
      ...
      <div className="absolute left-2 top-[45%] w-[66%] animate-float-y [animation-duration:4.3s] [animation-delay:0.25s]">
        <div className="relative rotate-[8deg] rounded-2xl border-2 border-[#A5B4FC] bg-white p-3.5 shadow-[0_20px_40px_-24px_rgba(79,70,229,0.7)]">
      ...
      <div className="absolute bottom-0 right-2 w-[68%] animate-float-y [animation-duration:3.2s] [animation-delay:0.12s]">
        <div className="relative rotate-[-9deg] rounded-2xl border-2 border-[#C4B5FD] bg-white p-4 shadow-[0_22px_44px_-24px_rgba(124,58,237,0.7)]">
