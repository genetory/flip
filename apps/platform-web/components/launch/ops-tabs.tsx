...
const TABS = [
  { href: "/launch/ops/students", label: "학생 관리" },
  { href: "/launch/ops/submissions", label: "제출물" },
  { href: "/launch/ops/report", label: "리포트" }
];
    ...
    <header className="sticky top-0 z-30 border-b border-[#EEF1F5] bg-white/90 backdrop-blur">
      <LaunchContainer className="!max-w-[640px]">
        <div className="flex h-12 items-center justify-between">
          ...
          <Link href="/launch" className="text-[12px] font-semibold text-[#8B95A1]">← 프로그램</Link>
        </div>
