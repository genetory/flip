    ...
    <Card className="md:!p-6">
      {state === "done" && stale ? (
        <div className="mb-3 flex flex-wrap items-center justify-between gap-2 rounded-lg bg-[#FFF9EC] px-3 py-2">
          ...
          >
            {busy ? t("받는 중…", "Getting…", "获取中…", "Đang nhận…", "受け取り中…", "Sedang mengambil…") : (<>{t("다시 받기", "Get again", "重新获取", "Nhận lại", "もう一度受け取る", "Ambil lagi")} <span className="font-semibold opacity-70">· ⚡2</span></>)}
          </button>
        </div>
      ) : null}
      ...
      {state === "loading" ? (
        ...
        <div className="text-center">
          ...
          >
            ...
            <span className="font-semibold opacity-70">· ⚡2</span>
          </button>
