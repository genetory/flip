        ...
        <div className="border-t border-[#EEF1F5] p-3">
          ...
          >
            <textarea
              ...
              disabled={loading}
              className="max-h-32 min-h-[46px] flex-1 resize-none rounded-xl border border-[#E5E8EB] bg-white px-3.5 py-3 text-[14px] text-[#191F28] outline-none transition placeholder:text-[#B0B8C1] focus:border-[#0B46E8] disabled:bg-[#F8FAFC]"
            />
            <button
              type="submit"
