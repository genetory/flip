          ...
          <div className="mt-9 flex flex-col gap-10">
            ...
            <div>
              ...
              <div className="grid gap-3 sm:grid-cols-2">
                ...
                <LinkCard emoji="🔎" href="/positions" title={t("APLY에서 지원하기", "Apply on APLY", "在 APLY 投递", "Ứng tuyển trên APLY", "APLYで応募する", "Lamar di APLY")} desc={t("완성한 서류로 실제 공고에 지원", "Use your documents on real jobs", "用完成的文件投递真实职位", "Dùng hồ sơ cho việc làm thật", "完成した書類で実際の求人に応募", "Gunakan dokumenmu untuk lowongan nyata")} external />
              </div>
            </div>
          </div>
          </Reveal>
