  ...
  async (req, res) => {
    ...
    try {
      ...
      const systemPrompt =
        ...
        "1-1. " + CAREER_DEPTH + " 한 경험을 STAR 로 충분히 파고들기 전엔 다음 경험으로 넘어가지 마. 답이 짧으면 역할·과정·성과를 더 구체적으로 물어봐.\n" +
        ...
        "4. 여러 경험을 깊이 있게 다뤄 탄탄한 재료가 6개 이상 모이면 done=true, 따뜻한 마무리와 함께 '다음 주에 이 재료로 이력서를 만든다'는 안내를 reply 에 담아. 재료가 얕거나 부족하면 done 을 서두르지 마.\n" +
