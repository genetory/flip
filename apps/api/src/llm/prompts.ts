...
export function buildCoverLetterMessages(input: CoverLetterInput): LlmMessages {
  ...
  const system =
    ...
    "\n[좋은 자소서의 조건 — 반드시 지킬 것]\n" +
    "· show, don't tell: '성실합니다/열정이 있습니다/문제 해결에 기여하고자' 같은 추상적 선언은 쓰지 말고, 그 성격이 드러난 구체적 상황·행동으로 보여주세요. 형용사가 아니라 '무엇을 어떻게 했는지'로.\n" +
    "· 공허한 상투어 금지: '효율적이고 창조적인', '가치 창출/가치를 창출', '실질적인 가치', '잠재력을 극대화', '역량을 바탕으로', '효율적인 결과를 도출', '간절히 희망', '귀사의 ~한 가치', '최선을 다하겠습니다', '열정을 가지고', '다양한 역량' 처럼 누구에게나 붙는 뻔한 표현은 쓰지 마세요. 이런 추상 명사구로 문장을 채우는 대신, 그 자리에 지원자만의 구체적 사실(무엇을 했고 무엇을 배웠는지)을 넣으세요.\n" +
    "· 구체 사실을 앞으로: 추상적 각오·포부·미사여구로 앞 두세 문장을 낭비하지 마세요. 늦어도 두 번째 문장 안에 반드시 지원자만의 구체적 사실(실제 경험·스킬, 또는 공고와의 접점) 하나가 등장해야 합니다. 글 전체가 '무엇을 하고 싶다'는 바람이 아니라 '무엇을 해봤다'는 근거로 채워져야 합니다.\n" +
    "· 구체가 설득한다: 경험은 '언제, 어떤 상황에서, 내가 무엇을, 어떻게, 그래서 무엇을 배웠/이뤘는지'가 드러나게 한 장면이라도 생생하게. 두루뭉술한 요약보다 구체적 장면 하나가 낫습니다.\n" +
    (jd
      ? "· 공고 1:1 연결: 공고의 요구사항을 하나 콕 집어, 내 어떤 경험·역량이 그걸 충족하는지 짝지어 서술하세요('귀사의 ~ 가치에 공감' 같은 뭉뚱그림 금지).\n"
      : "") +
    "· 첫 문장(두괄식)은 뻔한 인사말이 아니라, 이 사람을 더 알고 싶게 만드는 핵심 메시지로 시작하세요.\n" +
    "\n[문체 참고 — 아래 '내용'은 절대 가져오지 말고, 오직 톤·구체성·자연스러움만 참고]\n" +
    "  예시: \"편의점 야간 아르바이트를 하던 여섯 달 동안 가장 자주 들은 말은 '이거 언제 다시 들어와요'였습니다. 창고를 매번 뒤지는 대신 잘 나가는 품목을 노트에 적어 발주 주기를 바꿨더니 품절 문의가 눈에 띄게 줄었습니다. 대단한 성과는 아니지만, 불편을 그냥 지나치지 않고 손닿는 선에서 고쳐 보는 일이 저는 즐거웠습니다.\"\n" +
    "  이 예시처럼 — 실제 장면에서 시작하고, 내가 한 구체적 행동과 작은 결과를 담담하게 말하며, 과장 없이 사람 목소리로 씁니다. 위 편의점 이야기 자체를 답변에 넣지는 마세요(어디까지나 말투·구체성의 본보기).\n" +
    "· 마무리(입사 후 포부)는 '~에 기여하고 싶습니다 / 가치를 전달하고 싶습니다 / 회사의 성장에 기여하고 싶습니다 / 극대화하고 싶습니다' 같은 막연한 각오로 끝내지 마세요. 대신 지원자의 실제 경험·스킬을 근거로, 이 회사·직무에서 '구체적으로 무엇을 어떻게 하겠다'는 실행 계획 한 가지를 담으세요(예: 두루뭉술한 '기여' 대신 '어떤 기능/업무를 맡아 무엇을 개선하겠다').\n" +
    "6. 한국어로만 작성하세요.\n" +
    (keywordList.length
